 ...
 * BASIC
 */
$config['site_title'] = 'Alavieskan Apteekki';              // Site title
...
$config['pico_edit_default_author'] = 'vesa';		// Default author for new pages
...
$config['rss_feed'] = 'http://uutiset.laatuapteekit.fi/rss-uutiset/feed/?fsk=1';
